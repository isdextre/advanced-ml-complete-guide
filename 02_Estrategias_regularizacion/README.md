...
Este bloque cubre tres temas fundamentales para dominar la regularización y evitar overfitting:
...
```
02_Estrategias_regularizacion/
├── README.md (este archivo)
├── slides/
│   └── bloque2.pdf
├── data/
│   ├── 01_L1_L2_ElasticNet.csv
│   ├── 02_Arboles_Regularizacion.csv
│   └── 03_Ensambles_Hibridos.csv
└── notebooks/
    ├── 01_L1_L2_ElasticNet.ipynb
    ├── 02_Arboles_Regularizacion.ipynb
    └── 03_Ensambles_Hibridos.ipynb
```
